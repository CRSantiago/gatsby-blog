    ...
    const pageQuery = useStaticQuery(graphql`
      query {
        file(relativePath: { eq: "about-me.jpg" }) {
          childImageSharp {
            fluid (maxWidth:300,maxHeight:325,quality:100){
